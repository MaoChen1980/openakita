...
MyAgent's skill system enables dynamic capability extension.
...
myagent skills run my_skill --input "test data"

# Install a skill from GitHub
myagent skills install github:user/repo/skill_name
```
...
MyAgent can search GitHub for skills:
